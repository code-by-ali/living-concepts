  ...
  return (
    <section className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        {/* Download Button */}
        <button className="inline-flex items-center cursor-pointer gap-3 px-1 py-2 min-w-60 bg-white text-primary hover:bg-gray-100 transition-all duration-300 rounded-full group">
          <div className="w-10 h-10 bg-primary flex items-center justify-center rounded-full">
            <ArrowUpRight className="w-5 h-5 text-white" />
          </div>
          <span className="font-normal text-base grow text-primary">
            DOWNLOAD NOW
          </span>
        </button>
      </div>
